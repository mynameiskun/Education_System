...
namespace XCode.Membership
{
    ...
    [BindIndex("IX_Student_RoleID", false, "RoleID")]
    [BindTable("Student", Description = "用户", ConnName = "Membership", DbType = DatabaseType.SqlServer)]
    public partial class Student<TEntity> : IStudent
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
