...
namespace NewLife.School.Enity
{
    ...
    public partial class Course : Entity<Course>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Course[课程计划表]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Course[课程计划表]数据！");
        //}
        ...
        #region 扩展查询
        /// <summary>根据课程号查找</summary>
        /// <param name="id">课程号</param>
        /// <returns>实体对象</returns>
        public static Course FindByID(Int32 id)
        {
            if (id <= 0) return null;
        ...
        /// <summary>根据课程名称查找</summary>
        /// <param name="name">课程名称</param>
        /// <returns>实体列表</returns>
        public static IList<Course> FindAllByName(String name)
        {
            // 实体缓存
